...
class DviOut extends Module {
    ...
    val io = IO( new Bundle{
        val video = Input(videoIoType)      // Video signal input
        val dviClock = Output(UInt(10.W))   // DVI clock signal output.
        val dviData0 = Output(UInt(10.W))   // DVI Data 0 signal output.
        val dviData1 = Output(UInt(10.W))   // DVI Data 1 signal output.
        val dviData2 = Output(UInt(10.W))   // DVI Data 2 signal output.
    })
