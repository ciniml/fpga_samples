set_option -output_base_name cpu_stopwatch
...
add_file -type verilog [file normalize ../../rtl/util/simple_fifo.sv]
add_file -type verilog [file normalize ../../rtl/uart/uart_tx.sv]
add_file -type verilog [file normalize ../../rtl/uart/uart_rx.sv]
add_file -type verilog [file normalize ../../external/picorv32/picorv32.v]
