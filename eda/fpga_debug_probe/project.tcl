...
# Additional args
set DEBUG_PROBE_CORE_SRC  [lindex $argv 6]
...
#add_file -type verilog [file normalize ${DEBUG_PROBE_CORE_SRC}]
...
if {${TARGET} == "tangprimer25k"} {
    ...
    add_file -type verilog [file normalize ${SRC_DIR}/ip/easycdr/easycdr.v]
}
