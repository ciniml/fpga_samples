...
if  {${TARGET} == "kiwinano4k"} {
    add_file -type verilog [file normalize ${SRC_DIR}/ip/gowin_pllvr/gowin_pllvr.v]
    add_file -type verilog [file normalize ${SRC_DIR}/ip/psram_memory_interface_hs/psram_memory_interface_hs.v]
} else {
